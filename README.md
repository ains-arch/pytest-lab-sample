# Pytest Lab [![](https://github.com/ains-arch/pytest-lab-sample/workflows/tests/badge.svg)](https://github.com/ains-arch/pytest-lab-sample/actions?query=workflow%3Atests)
